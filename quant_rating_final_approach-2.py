...
for elem in ['Evolution_Rating','RATING_ENCODED','BLOOMBERG_ENCODED_RATING','DELTA_RATING_ENCODED','DELTA_BLOOMBERG_ENCODED_RATING','ALTMAN_Z_SCORE','DELTA_ALTMAN_Z_SCORE','BB_1YR_DEFAULT_PROB','DELTA_BB_1YR_DEFAULT_PROB']:
...
rf = RandomForestClassifier(max_depth=30, n_estimators=100, max_features=30, n_jobs=-1,class_weight='balanced')
