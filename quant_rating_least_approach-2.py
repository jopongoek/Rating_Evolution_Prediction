...
#rf = mord.LogisticAT(alpha=1.)
#rf=EllipticEnvelope(contamination=0.2)
...
#
#def downgrade_f1_scorer(y_true, y_predict):
...
#
#
#new_scorer = make_scorer(downgrade_f1_scorer,greater_is_better=True)
#
